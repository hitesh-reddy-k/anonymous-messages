...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    try {
        const response = await fetch("https://anoniymous-messages.vercel.app/anonymousMessages/me", {
            method: "GET",
            headers: {
        ...
        if (data.success) {
            ...
            anonLink.value = `https://anoniymous-messages.vercel.app/anonymousMessages/${data.users._id}`;

            const messagesResponse = await fetch("https://anoniymous-messages.vercel.app/anonymousMessages/getMessages", {
                method: "GET",
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${getToken()}`
...
document.getElementById("save-button").addEventListener("click", async () => {
    ...
    try {
        const response = await fetch("https://anoniymous-messages.vercel.app/anonymousMessages/updateUsername", {
            method: "PUT",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${getToken()}`
